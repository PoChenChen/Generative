...
def test_simple_app():
    ...
    try:
        ...
        print("💡 請先運行：python run_simple.py")
        return False
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"   生成文案: {gen_data['generated_text']}")
        else:
    ...
    print("\n" + "=" * 50)
    print("🎉 所有測試通過！簡化版本應用運行正常")
    return True

def main():
    """主函數"""
    print("🚀 AI 文案生成工具簡化版本測試")
    print("請確保簡化版本應用正在運行 (python run_simple.py)")
    print()
